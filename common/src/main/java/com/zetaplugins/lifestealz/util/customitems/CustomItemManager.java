...
public final class CustomItemManager {
    ...
    public static ItemStack getPlayerHead(OfflinePlayer offlinePlayer) {
        ...
        skullMeta.setDisplayName("<light_purple>" + offlinePlayer.getName());
    ...
    public static ItemStack getBedrockPlayerHead(UUID uuid) {
        ...
        skullMeta.setDisplayName("<light_purple>" + LifeStealZ.getInstance().getGeyserManager().getOfflineBedrockPlayerName(uuid));
